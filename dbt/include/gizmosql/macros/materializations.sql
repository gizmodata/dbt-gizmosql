{#
  ...
  pattern (CREATE __dbt_tmp, RENAME existing to __dbt_backup, RENAME __dbt_tmp
  to target). Over Flight SQL, the PREPARE phase of subsequent statements may
  not see recently auto-committed DDL, causing sporadic "Catalog Error: Table
  ... does not exist" failures on the RENAME step.
